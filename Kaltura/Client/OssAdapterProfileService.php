...
class Kaltura_Client_OssAdapterProfileService extends Kaltura_Client_ServiceBase
{
	...
	/**
	 * @return Kaltura_Client_Type_OSSAdapterProfile
	...
	/**
	 * @return Kaltura_Client_Type_OSSAdapterProfileListResponse
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function listAction()
	{
		...
		$resultXmlObject = new \SimpleXMLElement($resultXml);
		$this->client->checkIfError($resultXmlObject->result);
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaOSSAdapterProfileListResponse");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_OSSAdapterProfileListResponse");
		return $resultObject;
	}
