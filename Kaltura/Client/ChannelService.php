...
class Kaltura_Client_ChannelService extends Kaltura_Client_ServiceBase
{
	...
	/**
	 * @return Kaltura_Client_Type_Channel
	...
	function listAction(Kaltura_Client_Type_ChannelsBaseFilter $filter = null, Kaltura_Client_Type_FilterPager $pager = null)
	{
		...
		$resultXmlObject = new \SimpleXMLElement($resultXml);
		$this->client->checkIfError($resultXmlObject->result);
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaChannelListResponse");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_ChannelListResponse");
		return $resultObject;
	}
	 ...
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function update($id, Kaltura_Client_Type_Channel $channel)
	{
		$kparams = array();
		$this->client->addParam($kparams, "id", $id);
		$this->client->addParam($kparams, "channel", $channel->toParams());
