 ...
 * @subpackage Client
 */
class Kaltura_Client_SegmentationTypeService extends Kaltura_Client_ServiceBase
{
	...
	/**
	 * @return Kaltura_Client_Type_SegmentationType
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function add(Kaltura_Client_Type_SegmentationType $segmentationType)
	{
		$kparams = array();
	...
	function listAction(Kaltura_Client_Type_BaseSegmentationTypeFilter $filter = null, Kaltura_Client_Type_FilterPager $pager = null)
	{
		...
		$resultXmlObject = new \SimpleXMLElement($resultXml);
		$this->client->checkIfError($resultXmlObject->result);
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaSegmentationTypeListResponse");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_SegmentationTypeListResponse");
		return $resultObject;
	}
	 ...
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function update($segmentationTypeId, Kaltura_Client_Type_SegmentationType $segmentationType)
	{
		$kparams = array();
	...
	function updatePartnerConfiguration(Kaltura_Client_Type_SegmentationPartnerConfiguration $configuration)
	{
		...
		$this->client->queueServiceActionCall("segmentationtype", "updatePartnerConfiguration", null, $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultXml = $this->client->doQueue();
		$resultXmlObject = new \SimpleXMLElement($resultXml);
