...
class Kaltura_Client_ReportService extends Kaltura_Client_ServiceBase
{
	...
	/**
	 * @return Kaltura_Client_Type_Report
	...
	/**
	 * @return Kaltura_Client_Type_ReportListResponse
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function listAction(Kaltura_Client_Type_ReportFilter $filter, Kaltura_Client_Type_FilterPager $pager = null)
	{
		$kparams = array();
