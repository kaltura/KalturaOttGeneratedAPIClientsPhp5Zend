 ...
 * @subpackage Client
 */
class Kaltura_Client_CategoryVersionService extends Kaltura_Client_ServiceBase
{
	 ...
	 */
	function add(Kaltura_Client_Type_CategoryVersion $objectToAdd)
	{
		$kparams = array();
	...
	/**
	 * @return Kaltura_Client_Type_CategoryVersionListResponse
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function listAction(Kaltura_Client_Type_CategoryVersionFilter $filter, Kaltura_Client_Type_FilterPager $pager = null)
	{
		$kparams = array();
		...
		$resultXmlObject = new \SimpleXMLElement($resultXml);
		$this->client->checkIfError($resultXmlObject->result);
		$resultObject = Kaltura_Client_ParseUtils::unmarshalObject($resultXmlObject->result, "KalturaCategoryVersionListResponse");
		$this->client->validateObjectType($resultObject, "Kaltura_Client_Type_CategoryVersionListResponse");
		return $resultObject;
	}
