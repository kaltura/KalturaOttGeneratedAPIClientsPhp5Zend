 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_AssetFilePpvFilter extends Kaltura_Client_Type_Filter
{
	public function getKalturaObjectType()
	{
		return 'KalturaAssetFilePpvFilter';
	}
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->assetFileIdEqual))
			$this->assetFileIdEqual = (string)$xml->assetFileIdEqual;
		if(!is_null($jsonObject) && isset($jsonObject->assetFileIdEqual))
			$this->assetFileIdEqual = (string)$jsonObject->assetFileIdEqual;
	}
	/**
