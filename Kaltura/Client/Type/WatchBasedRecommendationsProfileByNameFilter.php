 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_WatchBasedRecommendationsProfileByNameFilter extends Kaltura_Client_Type_WatchBasedRecommendationsProfileFilter
{
	public function getKalturaObjectType()
	{
		return 'KalturaWatchBasedRecommendationsProfileByNameFilter';
	}
