...
class Kaltura_Client_Type_OpcPartnerConfiguration extends Kaltura_Client_Type_PartnerConfiguration
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->resetPassword) && !empty($xml->resetPassword))
			$this->resetPassword = Kaltura_Client_ParseUtils::unmarshalObject($xml->resetPassword, "KalturaResetPasswordPartnerConfig");
		if(!is_null($jsonObject) && isset($jsonObject->resetPassword) && !empty($jsonObject->resetPassword))
			$this->resetPassword = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->resetPassword, "KalturaResetPasswordPartnerConfig");
	}
	/**
	 * Reset Password
	 *
