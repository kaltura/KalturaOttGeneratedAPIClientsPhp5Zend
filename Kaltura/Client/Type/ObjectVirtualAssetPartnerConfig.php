...
class Kaltura_Client_Type_ObjectVirtualAssetPartnerConfig extends Kaltura_Client_Type_PartnerConfiguration
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->objectVirtualAssets))
		{
		...
		if(!is_null($jsonObject) && isset($jsonObject->objectVirtualAssets))
		{
			if(empty($jsonObject->objectVirtualAssets))
				$this->objectVirtualAssets = array();
			else
				$this->objectVirtualAssets = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->objectVirtualAssets, "KalturaObjectVirtualAssetInfo");
		}
	}
	/**
