...
class Kaltura_Client_Type_OnDemandResponseProfile extends Kaltura_Client_Type_DetachedResponseProfile
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->retrievedProperties))
			$this->retrievedProperties = (string)$xml->retrievedProperties;
		if(!is_null($jsonObject) && isset($jsonObject->retrievedProperties))
			$this->retrievedProperties = (string)$jsonObject->retrievedProperties;
	}
	/**
