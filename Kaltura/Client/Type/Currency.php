 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_Currency extends Kaltura_Client_ObjectBase
{
	public function getKalturaObjectType()
	{
		return 'KalturaCurrency';
	}
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->sign))
			$this->sign = (string)$xml->sign;
		if(!is_null($jsonObject) && isset($jsonObject->sign))
			$this->sign = (string)$jsonObject->sign;
