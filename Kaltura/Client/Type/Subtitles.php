...
class Kaltura_Client_Type_Subtitles extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->detectedLanguage))
			$this->detectedLanguage = (string)$xml->detectedLanguage;
		if(!is_null($jsonObject) && isset($jsonObject->detectedLanguage))
			$this->detectedLanguage = (string)$jsonObject->detectedLanguage;
	}
	/**
