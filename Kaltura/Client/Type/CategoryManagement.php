...
class Kaltura_Client_Type_CategoryManagement extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->defaultTreeId))
			$this->defaultTreeId = (string)$xml->defaultTreeId;
		if(!is_null($jsonObject) && isset($jsonObject->defaultTreeId))
			$this->defaultTreeId = (string)$jsonObject->defaultTreeId;
		if(!is_null($xml) && count($xml->deviceFamilyToCategoryTree))
		{
		...
		if(!is_null($jsonObject) && isset($jsonObject->deviceFamilyToCategoryTree))
		{
			if(empty($jsonObject->deviceFamilyToCategoryTree))
				$this->deviceFamilyToCategoryTree = array();
			else
				$this->deviceFamilyToCategoryTree = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->deviceFamilyToCategoryTree, "KalturaLongValue");
		}
	}
	/**
