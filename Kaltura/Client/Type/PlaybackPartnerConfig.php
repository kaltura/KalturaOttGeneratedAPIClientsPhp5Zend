...
class Kaltura_Client_Type_PlaybackPartnerConfig extends Kaltura_Client_Type_PartnerConfiguration
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->defaultAdapters) && !empty($xml->defaultAdapters))
			$this->defaultAdapters = Kaltura_Client_ParseUtils::unmarshalObject($xml->defaultAdapters, "KalturaDefaultPlaybackAdapters");
		if(!is_null($jsonObject) && isset($jsonObject->defaultAdapters) && !empty($jsonObject->defaultAdapters))
			$this->defaultAdapters = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->defaultAdapters, "KalturaDefaultPlaybackAdapters");
	}
	/**
