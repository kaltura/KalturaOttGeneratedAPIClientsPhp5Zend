...
class Kaltura_Client_Type_PermissionItem extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->isExcluded))
		{
		...
		if(!is_null($jsonObject) && isset($jsonObject->isExcluded))
		{
			if(!empty($jsonObject->isExcluded) && ((int) $jsonObject->isExcluded === 1 || strtolower((string)$jsonObject->isExcluded) === 'true'))
				$this->isExcluded = true;
			else
				$this->isExcluded = false;
		}
