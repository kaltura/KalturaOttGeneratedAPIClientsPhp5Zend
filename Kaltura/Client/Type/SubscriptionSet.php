...
abstract class Kaltura_Client_Type_SubscriptionSet extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		{
			if(isset($xml->subscriptionIds->item) && count($xml->subscriptionIds->item))
				$this->multiLingual_subscriptionIds = Kaltura_Client_ParseUtils::unmarshalArray($xml->subscriptionIds, '');
			else
