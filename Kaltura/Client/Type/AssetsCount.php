 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_AssetsCount extends Kaltura_Client_ObjectBase
{
	public function getKalturaObjectType()
	{
		return 'KalturaAssetsCount';
	}
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->objects))
		{
			if(empty($xml->objects))
				...
				$this->objects = Kaltura_Client_ParseUtils::unmarshalArray($xml->objects, "KalturaAssetCount");
		}
		if(!is_null($jsonObject) && isset($jsonObject->objects))
		{
			if(empty($jsonObject->objects))
				...
				$this->objects = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->objects, "KalturaAssetCount");
		}
	}
	/**
	 * Field name
