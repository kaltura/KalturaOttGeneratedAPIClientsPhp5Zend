	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($jsonObject) && isset($jsonObject->objects))
		{
			if(empty($jsonObject->objects))
				...
				$this->objects = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->objects, "KalturaMediaFileDynamicData");
		}
	}
	/**
	 * A list of media-file types
	 *
	 * @var Kaltura_Client_Type_MediaFileDynamicData[]
	 */
	public $objects;
