 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_BulkUploadLiveAssetResult extends Kaltura_Client_Type_BulkUploadResult
{
	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		if(count($xml->programs))
		{
			if(empty($xml->programs))
				...
				$this->programs = Kaltura_Client_ParseUtils::unmarshalArray($xml->programs, "KalturaBulkUploadProgramAssetResult");
		}
	}
	/**
