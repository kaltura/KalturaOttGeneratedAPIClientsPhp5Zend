...
class Kaltura_Client_Type_WatchBasedRecommendationsProfile extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->recommendationsMediaTypeIds))
			$this->recommendationsMediaTypeIds = (string)$xml->recommendationsMediaTypeIds;
		if(!is_null($jsonObject) && isset($jsonObject->recommendationsMediaTypeIds))
			$this->recommendationsMediaTypeIds = (string)$jsonObject->recommendationsMediaTypeIds;
		if(!is_null($xml) && count($xml->recommendationsSeriesInfo) && !empty($xml->recommendationsSeriesInfo))
			$this->recommendationsSeriesInfo = Kaltura_Client_ParseUtils::unmarshalObject($xml->recommendationsSeriesInfo, "KalturaSeriesInfo");
		if(!is_null($jsonObject) && isset($jsonObject->recommendationsSeriesInfo) && !empty($jsonObject->recommendationsSeriesInfo))
			$this->recommendationsSeriesInfo = Kaltura_Client_ParseUtils::jsObjectToClientObject($jsonObject->recommendationsSeriesInfo, "KalturaSeriesInfo");
	}
	/**
	 ...
	 *
	 * @var Kaltura_Client_Type_SeriesInfo
	 */
