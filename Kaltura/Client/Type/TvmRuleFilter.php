 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_TvmRuleFilter extends Kaltura_Client_Type_Filter
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->ruleTypeEqual))
			$this->ruleTypeEqual = (string)$xml->ruleTypeEqual;
		if(!is_null($jsonObject) && isset($jsonObject->ruleTypeEqual))
			$this->ruleTypeEqual = (string)$jsonObject->ruleTypeEqual;
	 ...
	 *
	 * @var Kaltura_Client_Enum_TvmRuleType
	 */
