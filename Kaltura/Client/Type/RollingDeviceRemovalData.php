...
class Kaltura_Client_Type_RollingDeviceRemovalData extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->rollingDeviceRemovalPolicy))
			$this->rollingDeviceRemovalPolicy = (string)$xml->rollingDeviceRemovalPolicy;
		if(!is_null($jsonObject) && isset($jsonObject->rollingDeviceRemovalPolicy))
			$this->rollingDeviceRemovalPolicy = (string)$jsonObject->rollingDeviceRemovalPolicy;
		if(!is_null($xml) && count($xml->rollingDeviceRemovalFamilyIds))
			$this->rollingDeviceRemovalFamilyIds = (string)$xml->rollingDeviceRemovalFamilyIds;
		if(!is_null($jsonObject) && isset($jsonObject->rollingDeviceRemovalFamilyIds))
			$this->rollingDeviceRemovalFamilyIds = (string)$jsonObject->rollingDeviceRemovalFamilyIds;
	}
	/**
