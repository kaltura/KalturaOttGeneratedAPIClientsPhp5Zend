 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_FilteringCondition extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->metaName))
			$this->metaName = (string)$xml->metaName;
		if(!is_null($jsonObject) && isset($jsonObject->metaName))
			$this->metaName = (string)$jsonObject->metaName;
