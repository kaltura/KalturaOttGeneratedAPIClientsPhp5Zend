...
class Kaltura_Client_Type_CustomFieldsPartnerConfiguration extends Kaltura_Client_Type_PartnerConfiguration
{
	...
	public function __construct(SimpleXMLElement $xml = null, $jsonObject = null)
	{
		...
		if(!is_null($xml) && count($xml->metaSystemNameInsteadOfAliasList))
			$this->metaSystemNameInsteadOfAliasList = (string)$xml->metaSystemNameInsteadOfAliasList;
		if(!is_null($jsonObject) && isset($jsonObject->metaSystemNameInsteadOfAliasList))
			$this->metaSystemNameInsteadOfAliasList = (string)$jsonObject->metaSystemNameInsteadOfAliasList;
	}
	/**
