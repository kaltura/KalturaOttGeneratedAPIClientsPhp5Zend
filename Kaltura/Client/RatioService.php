 ...
 * @subpackage Client
 */
class Kaltura_Client_RatioService extends Kaltura_Client_ServiceBase
{
	...
	/**
	 * @return Kaltura_Client_Type_Ratio
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function add(Kaltura_Client_Type_Ratio $ratio)
	{
		$kparams = array();
	...
	/**
	 * @return Kaltura_Client_Type_RatioListResponse
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function listAction()
	{
	 ...
	 * @throws Kaltura_Client_Exception|Kaltura_Client_ClientException
	 */
	function update($id, Kaltura_Client_Type_Ratio $ratio)
	{
		$kparams = array();
