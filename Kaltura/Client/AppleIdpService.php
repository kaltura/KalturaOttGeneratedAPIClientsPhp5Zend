 ...
 * @subpackage Client
 */
class Kaltura_Client_AppleIdpService extends Kaltura_Client_ServiceBase
{
	...
	function attach($idToken)
	{
		...
		$this->client->queueServiceActionCall("appleidp", "attach", "KalturaSocialAttachStatus", $kparams);
	...
	{
		$kparams = array();
		$this->client->queueServiceActionCall("appleidp", "detach", "KalturaSocialAttachStatus", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$rawResult = $this->client->doQueue();
		if ($this->client->getConfig()->format === Kaltura_Client_ClientBase::KALTURA_SERVICE_FORMAT_JSON) {
	...
	{
		$kparams = array();
		$this->client->queueServiceActionCall("appleidp", "getServiceId", "KalturaSocialServiceId", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$rawResult = $this->client->doQueue();
		if ($this->client->getConfig()->format === Kaltura_Client_ClientBase::KALTURA_SERVICE_FORMAT_JSON) {
	...
	{
		$kparams = array();
		$this->client->queueServiceActionCall("appleidp", "isAttached", "KalturaSocialAttachStatus", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$rawResult = $this->client->doQueue();
		if ($this->client->getConfig()->format === Kaltura_Client_ClientBase::KALTURA_SERVICE_FORMAT_JSON) {
	...
	function login($partnerId, $idToken, array $extraParams = null, $udid = null)
	{
		...
		$this->client->queueServiceActionCall("appleidp", "login", "KalturaLoginResponse", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$rawResult = $this->client->doQueue();
		if ($this->client->getConfig()->format === Kaltura_Client_ClientBase::KALTURA_SERVICE_FORMAT_JSON) {
	...
	function setServiceId($serviceId)
	{
		...
		$this->client->queueServiceActionCall("appleidp", "setServiceId", "KalturaSocialServiceId", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$rawResult = $this->client->doQueue();
		if ($this->client->getConfig()->format === Kaltura_Client_ClientBase::KALTURA_SERVICE_FORMAT_JSON) {
